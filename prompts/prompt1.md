...
> Since you or Mr app development, I have a good one for you to consider. We're going
...
> pay.
>
> So the needs to be an app that can do all the math for people
>
...
>
> It would be better if I could just go on a nap put in a couple things and it would
> determine everything for me

Follow-up, sent mid-turn:

> record this as prompt1 in a file and your respose
